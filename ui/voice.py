...
更新:
1. [核心] AI推理优先走 HTTP 调用外部 ui/whisper_server.py (模型常驻，重启秒可用)
...
用法:
- 先启动服务:  python ui/whisper_server.py
- 再启动主程序: python -m simulation.main --mode demo
